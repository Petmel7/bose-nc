    ...
    <div class="slider">
        ...
        <div class="reviews-block">
            ...
            <article class="reviews-article">
                ...
                <p class="reviews-text general-text">Critically acclaimed for their powerful noise cancelling, astonishing sound, and unrivaled voice pickup, Bose Noise Cancelling Headphones 700 help turn any space into the perfect place to listen to music, get work done, or just shut out the world for a few moments and relax </p>
            </article>
        </div>
        ...
        <div class="reviews-block">
            ...
            <article class="reviews-article">
                <h3 class="reviews-text--red general-title--small">Bose Сorporation</h3>
                <p class="reviews-text general-text">Bose Noise Cancelling Headphones 700 deliver everything you expect — and things you never imagined possible. The perfect balance of quiet, comfort, and sound </p>
            </article>
        </div>
        ...
        <div class="reviews-block">
            ...
            <article class="reviews-article">
                <h3 class="reviews-text--red general-title--small">Bose Сorporation</h3>
                <p class="reviews-text general-text">Real stories of people tuning in or out to feel peace, find escape, and for self-care </p>
            </article>
        </div>

    </div>
    <div class="pagination">
        <span class="pagination-item active">01 -</span>
        <span class="pagination-item">02 -</span>
        <span class="pagination-item">03 -</span>
    </div>
</section>